...
Here it should be noted that for clarity reasons. As one can see, the values of Paris and sometimes it's region have been set to NA. This has been done because Paris is such an outlier in terms of criminality or density that the color scale is unable to show the differences between the remaining departments. As such, it has been decided to take this value out of the scale for clarity reasons. In previous non-interactive maps, Paris has been assigned it's value. 
